...
public class Coin : MonoBehaviour {
	...
	public void OnCoinClicked () {
        ...
        Instantiate(coinPooft, coinPoofPrefab.transform.position, Quaternion.identity);
        Destroy(coinPoofPrefab,0.5f);
